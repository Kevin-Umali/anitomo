...
app.get(["/", "/v1"], (_, res: Response) => {
  sendSuccess(res, {
    ...
    providers: [
      { name: "Gogoanime", route: "/v1/gogoanime" },
      { name: "Marin", route: "/v1/marin" },
      { name: "Animefox", route: "/v1/animefox" },
      { name: "Animepahe", route: "/v1/animepahe" },
      { name: "Animesaturn", route: "/v1/animesaturn" },
      { name: "Crunchyroll", route: "/v1/crunchyroll" },
      { name: "Enime", route: "/v1/enime" },
      { name: "Zoro / Aniwatch", route: "/v1/zoro" },
    ],
